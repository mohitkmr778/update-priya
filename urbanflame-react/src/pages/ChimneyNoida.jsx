  ...
  />
      ...
      <section className="max-w-6xl mx-auto px-4 py-16 text-gray-700">
        <h2 className="text-2xl font-bold text-cyan-600 mb-4">
          Professional Kitchen Chimney Repair Service in Noida
        </h2>

        <p className="leading-7 mb-6">
          Priya Chimney is a trusted name for kitchen chimney repair service in Noida.
...
<p className="leading-7 mb-6">
  We are known as one of the best chimney service centers in Noida because
...
<p className="leading-7 mb-8">
  We provide chimney repair services across all areas of Noida including
